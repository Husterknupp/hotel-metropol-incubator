...
- [#6](https://github.com/Husterknupp/hotel-metropol-incubator/issues/6) Sichtbares Fehler-Signal auf GitHub bei gescheitertem `openclaw agent`-Aufruf — durch die Outcome-Reaktionen aus #7 abgedeckt, sollte geschlossen werden
